...
int ce103_fibonacciNumber(int fiIndex)
{
	...
	// I define two different value
	// I used for loop for that which calculates until our number
	int n1 = 0, n2 = 1;
...
{
	//TODO:Start from Here...
	// I used for loop to change which we want
	char ch;
	char* p = fiStr;
	char* q = fiStr;
...
{
	//TODO:Start from Here...
	// It count that how many letter there
...
{
	//TODO:Start from Here...
	// for each number it calculate it
...
{
	// it calculate binary number to hexademical
	//if there are five number it start from left two power and it increases power of number until last number
	// and if number is 1 it multiply with 1
	// if number is 0 it mulriply with 0
